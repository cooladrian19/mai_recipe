    ...
    <div className="footer-margin">
      ...
      <div className="tab-container">
        ...
        <div className="search-instructions">
              <ol>
                <li>
                  Click on the section tabs to switch between different
                  ingredient categories. Each tab represents a specific group of
                  ingredients.
                </li>
                <li>
                  Within each section, you'll find a list of ingredients related
                  to the chosen category. Check the checkbox
                  ingredient you want to include in your selection.
                </li>
                <li>
                  Once you've selected your desired ingredients, review your choices to ensure you've included
                  everything you have.
                </li>
                <li>
